package com.library.citadel_library.exception;

import com.library.citadel_library.exception.message.ApiResponseError;
...
@ControllerAdvice
public class CitadelLibraryExceptionHandler extends ResponseEntityExceptionHandler {
